    ...
    <div class="w3-top">
        <div class="w3-bar w3-white w3-wide w3-padding w3-card">
            ...
            <div class="w3-bar w3-white">
                <a class="w3-bar-item w3-button w3-hide-small w3-right" href="<?php echo e(url('logout')); ?>">Logout</a>
                <a class="w3-bar-item w3-button w3-hide-small w3-right" href="">Profile</a>
                <a class="w3-bar-item w3-button w3-hide-small w3-right" href="<?php echo e(url('newsub')); ?>">Register Subject</a>
                <a href="javascript:void(0)" onClick="sideMenu()"
                    class="w3-bar-item w3-button w3-hide-large w3-hide-medium">&#9776</a>
                <a href="<?php echo e(url('mainpage')); ?>" class="w3-bar-item w3-button"><b>MYTutor</b></a>
            </div>

            <div id="idsidebar" class="w3-bar-block w3-white w3-hide-medium w3-hide-large w3-hide">
                <a class="w3-bar-item w3-button" href="<?php echo e(url('logout')); ?>">Logout</a>
                <a class="w3-bar-item w3-button" href="<?php echo e(url('newsub')); ?>">Register Subject</a>
    ...
    <h2><b>Subjects List</b></h2><hr />
        <table class="w3-table w3-striped w3-bordered w3-margin-top">
            <thead><th>ID</th><th>Title</th><th>Description</th><th>Price</th><th>Learning Hours</th></thead>
                <?php $__currentLoopData = $listsubjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td><?php echo e($loop->iteration); ?></td>
                    <td><?php echo e($sub->title); ?></td>
                    <td><?php echo e($sub->description); ?></td>
                    <td><?php echo e($sub->price); ?></td>
                    <td><?php echo e($sub->hours); ?></td>
                </tr>
...
</html><?php /**PATH C:\Users\ASUS\Documents\WE\laravel\MyTutor\resources\views/mainpage.blade.php ENDPATH**/ ?>