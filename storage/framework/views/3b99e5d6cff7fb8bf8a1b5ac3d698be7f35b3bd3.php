...
<body>
    ...
    <?php endif; ?>
    <?php if(session('error')): ?> <script> alert("Failed"); </script>
    <?php endif; ?>
        ...
        <div style="display:flex; justify-content: center">
            ...
            <form action="<?php echo e(route('login.post')); ?>" method="post" accept-charset="UTF-8">
                <?php echo e(csrf_field()); ?>
                    ...
                    <p style="font-size:16px;"> Don't have an account? <a href="<?php echo e(url('registration')); ?>">Register</a></p>
...
</html><?php /**PATH C:\Users\ASUS\Documents\WE\laravel\MyTutor\resources\views/login.blade.php ENDPATH**/ ?>